<!--
Bundled worked example for the `design-reference` skill.
Source : https://styles.refero.design/style/530eb4cf-7e75-4833-95c9-746818050db7
Style  : "Base" (Coinbase Base) - Refero Styles - captured 2026-06-05
This is a complete DESIGN.md. Study it, and use its shape as the template when you
adopt a system into a project (see SKILL.md, step 5).
-->
